...
func (c *Qobuz) getDownloadURL(trackID, quality string, forceRefresh bool) (string, error) {
...
func (c *Qobuz) getQuality() string {
...
func (c *Qobuz) getExtension(quality string) string {
	if quality == "5" {
		return "mp3"
	}
	return "flac"
